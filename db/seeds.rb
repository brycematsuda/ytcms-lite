...
loves2 = Episode.create(:season_id => 2, :name => 'Stage 2', :position => 2, :visible => 'true', :embed_code => '<iframe width="560" height="315" src="//www.youtube.com/embed/CUXMpAMlSy0?rel=0" frameborder="0" allowfullscreen></iframe>', :description => 'Song: t+pazolite - nekosogi Destruction')
